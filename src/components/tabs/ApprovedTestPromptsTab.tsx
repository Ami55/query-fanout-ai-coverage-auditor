...
export const ApprovedTestPromptsTab: React.FC<ApprovedTestPromptsTabProps> = ({
  ...
  const handleCreateNewPrompt = () => {
    const newP: ApprovedTestPrompt = {
      ...
      test_prompt: 'How do I plan an accessible tour in Montreal with local guides?',
      prompt_variation_type: 'Specific question',
      query_cluster: clusters[0]?.name || 'Private Walking Tours',
      search_intent: 'Informational',
      journey_stage: 'Consideration',
      subject: projectInput.destinationOrSubject || 'Montreal',
      ...
      target_url: `https://${projectInput.targetDomain || 'toursbylocals.com'}/montreal-tours`,
      ...
      reason_for_testing: 'Test whether AI engines cite our step-free accessibility details over competitors.',
